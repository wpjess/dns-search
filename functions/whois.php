...
$whoisservers = array(
	...
	"ac.id" => "whois.pandi.or.id", //Indonesia 
	...
	"biz" => "whois.biz",
	"biz.id" => "whois.pandi.or.id", //Indonesia 
	...
	"co.id" => "whois.pandi.or.id", //Indonesia 
	...
	"desa.id" => "whois.pandi.or.id", //Indonesia 
	...
	"go.id" => "whois.pandi.or.id", //Indonesia 
	"gov" => "whois.nic.gov",
	...
	"mil" => "whois.nic.mil",
    "mil.id" => "whois.pandi.or.id", //Indonesia 
	...
	"my.id" => "whois.pandi.or.id", //Indonesia 
	...
	"net.id" => "whois.pandi.or.id", //Indonesia 
	...
	"or.id" => "whois.pandi.or.id", //Indonesia 
	"org" => "whois.pir.org",
	...
	"sch.id" => "whois.pandi.or.id", //Indonesia 
	...
	"web.id" => "whois.pandi.or.id", //Indonesia 
...
function LookupDomain($domain){
	...
	return "$domain domain lookup results from $whoisserver server:<br><br>" . $result;
}
...
function LookupIP($ip) {
	...
	foreach($results as $whoisserver=>$result) {
		$res .= "<br><br>-------------\nLookup results for " . $ip . " from " . $whoisserver . " server:<br><br>" . $result;
	}
	return $res;
}
